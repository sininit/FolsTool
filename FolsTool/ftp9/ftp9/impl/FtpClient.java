...
import top.fols.box.util.Base64Utils9;
...
import top.fols.box.net.base.ftp9.*;
import java.util.*;


public class FtpClient extends top.fols.box.net.base.ftp9.FtpClient {
        ...
        public FtpDirEntry parseLine(String line) {
            ...
            if (filename != null) {
                ...
                if (d != null && time != null) {
                    int c = time.indexOf(':');
                    now.setTime(d);
                    now.set(Calendar.HOUR, parseInt(time, 0, c, 10));
                    now.set(Calendar.MINUTE, parseInt(time, c + 1, time.length(), 10));
                    d = now.getTime();
                }
    ...
    private boolean issueCommand(String cmd) throws IOException,
            top.fols.box.net.base.ftp9.FtpProtocolException {
        if (!isConnected()) {
        ...
        if (replyPending) {
            try {
                completePending();
            } catch (top.fols.box.net.base.ftp9.FtpProtocolException e) {
                // ignore...
            }
        }
        if (cmd.indexOf('\n') != -1) {
            top.fols.box.net.base.ftp9.FtpProtocolException ex
                    = new top.fols.box.net.base.ftp9.FtpProtocolException("Illegal FTP command");
     ...
     */
    private void issueCommandCheck(String cmd) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
        if (!issueCommand(cmd)) {
            throw new top.fols.box.net.base.ftp9.FtpProtocolException(cmd + ":" + getResponseString(), getLastReplyCode());
        }
    }
     ...
     */
    private Socket openPassiveDataConnection(String cmd) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
        String serverAnswer;
        int port;
        ...
        if (issueCommand("EPSV ALL")) {
            ...
            if (!m.find()) {
                throw new top.fols.box.net.base.ftp9.FtpProtocolException("EPSV failed : " + serverAnswer);
            }
            ...
            if (!m.find()) {
                throw new top.fols.box.net.base.ftp9.FtpProtocolException("PASV failed : " + serverAnswer);
            }
        ...
        if (useCrypto) {
            try {
                ...
                throw new top.fols.box.net.base.ftp9.FtpProtocolException("Can't open secure data channel: " + e);
            }
        }
        if (!issueCommand(cmd)) {
            s.close();
     ...
     */
    private Socket openDataConnection(String cmd) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
        Socket clientSocket;
        ...
        if (proxy != null && proxy.type() == Proxy.Type.SOCKS) {
            ...
            // throw an exception
            throw new top.fols.box.net.base.ftp9.FtpProtocolException("Passive mode failed");
        }
     ...
     *
     */
    public static top.fols.box.net.base.ftp9.FtpClient create() {
     ...
     * @see #setActiveMode()
     */
    public top.fols.box.net.base.ftp9.FtpClient enablePassiveMode(boolean passive) {
     ...
     * @return This FtpClient
     */
    public top.fols.box.net.base.ftp9.FtpClient setConnectTimeout(int timeout) {
     ...
     * @return This FtpClient
     */
    public top.fols.box.net.base.ftp9.FtpClient setReadTimeout(int timeout) {
        readTimeout = timeout;
        return this;
    }
    ...
    public top.fols.box.net.base.ftp9.FtpClient setProxy(Proxy p) {
        proxy = p;
        return this;
    }
    ...
    public top.fols.box.net.base.ftp9.FtpClient connect(SocketAddress dest) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
     ...
     */
    public top.fols.box.net.base.ftp9.FtpClient connect(SocketAddress dest, int timeout) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
        ...
        if (!readReply()) {
            throw new top.fols.box.net.base.ftp9.FtpProtocolException("Welcome message: " +
    ...
    private void tryLogin(String user, char[] password) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
     ...
     */
    public top.fols.box.net.base.ftp9.FtpClient login(String user, char[] password) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
        if (!isConnected()) {
            throw new top.fols.box.net.base.ftp9.FtpProtocolException("Not connected yet", FtpReplyCode.BAD_SEQUENCE);
        }
     ...
     */
    public top.fols.box.net.base.ftp9.FtpClient login(String user, char[] password, String account) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
     ...
     */
    public top.fols.box.net.base.ftp9.FtpClient changeDirectory(String remoteDirectory) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
     ...
     * @throws IOException
     */
    public top.fols.box.net.base.ftp9.FtpClient changeToParentDirectory() throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
     ...
     * @throws IOException
     */
    public String getWorkingDirectory() throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
     ...
     */
    public top.fols.box.net.base.ftp9.FtpClient setRestartOffset(long offset) {
        if (offset < 0) {
     ...
     */
    public top.fols.box.net.base.ftp9.FtpClient getFile(String name, OutputStream local) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
        int mtu = 1500;
        if (restartOffset > 0) {
            Socket s;
            try {
     ...
     * @throws IOException if an error occurred during the transmission.
     */
    public InputStream getFileStream(String name) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
        Socket s;
        if (restartOffset > 0) {
            try {
                s = openDataConnection("REST " + restartOffset);
    ...
    public OutputStream putFileStream(String name, boolean unique)
        throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException
    {
     ...
     * @see #getLastFileName()
     */
    public top.fols.box.net.base.ftp9.FtpClient putFile(String name, InputStream local, boolean unique) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
        String cmd = unique ? "STOU " : "STOR ";
        int mtu = 1500;
     ...
     * @throws IOException if an error occurred during the transmission.
     */
    public top.fols.box.net.base.ftp9.FtpClient appendFile(String name, InputStream local) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
        int mtu = 1500;
     ...
     */
    public top.fols.box.net.base.ftp9.FtpClient rename(String from, String to) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
     ...
     */
    public top.fols.box.net.base.ftp9.FtpClient deleteFile(String name) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurred during the exchange
     */
    public top.fols.box.net.base.ftp9.FtpClient makeDirectory(String name) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurred during the exchange.
     */
    public top.fols.box.net.base.ftp9.FtpClient removeDirectory(String name) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
     ...
     */
    public top.fols.box.net.base.ftp9.FtpClient noop() throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurred during the transmission.
     */
    public String getStatus(String name) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurs during the transmission.
     */
    public List<String> getFeatures() throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
        /*
     ...
     * @throws IOException if an error occurred during the transmission.
     */
    public top.fols.box.net.base.ftp9.FtpClient abort() throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
     ...
     * @throws IOException
     */
    public top.fols.box.net.base.ftp9.FtpClient completePending() throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
        while (replyPending) {
            replyPending = false;
            if (!readReply()) {
                throw new top.fols.box.net.base.ftp9.FtpProtocolException(getLastResponseString(), lastReplyCode);
            }
        }
        return this;
    }
     ...
     * @throws FtpProtocolException if the command fails
     */
    public top.fols.box.net.base.ftp9.FtpClient reInit() throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
     ...
     */
    public top.fols.box.net.base.ftp9.FtpClient setType(TransferType type) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
        String cmd = "NOOP";
     ...
     */
    public InputStream list(String path) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
        Socket s;
     ...
     * @throws IOException if an error occurs during the transmission.
     */
    public InputStream nameList(String path) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
        Socket s;
     ...
     * @throws IOException if an error occurs during the transmission.
     */
    public long getSize(String path) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurs during the transmission.
     */
    public Date getLastModified(String path) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
     ...
     * @see #listFiles(String)
     */
    public top.fols.box.net.base.ftp9.FtpClient setDirParser(FtpDirParser p) {
        parser = p;
        return this;
    }
     ...
     * @see #changeDirectory(String)
     */
    public Iterator<FtpDirEntry> listFiles(String path) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
        Socket s = null;
        BufferedReader sin = null;
        try {
            s = openDataConnection(path == null ? "MLSD" : "MLSD " + path);
        } catch (top.fols.box.net.base.ftp9.FtpProtocolException FtpException) {
    ...
    private boolean sendSecurityData(byte[] buf) throws IOException,
            top.fols.box.net.base.ftp9.FtpProtocolException {
        String s = Base64Utils9.getMimeEncoder().encodeToString(buf);
        return issueCommand("ADAT " + s);
    }

    private byte[] getSecurityData() throws UnsupportedEncodingException {
        String s = getLastResponseString();
        if (s.substring(4, 9).equalsIgnoreCase("ADAT=")) {
            // Need to get rid of the leading '315 ADAT='
            // and the trailing newline
            return Base64Utils9.getMimeDecoder().decode(s.substring(9, s.length() - 1));
        }
        return null;
    }
     ...
     * @throws IOException if an error occurs during the transmission.
     */
    public top.fols.box.net.base.ftp9.FtpClient useKerberos() throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
        /*
     ...
     */
    public top.fols.box.net.base.ftp9.FtpClient startSecureSession() throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
        if (!isConnected()) {
            throw new top.fols.box.net.base.ftp9.FtpProtocolException("Not connected yet", FtpReplyCode.BAD_SEQUENCE);
        }
        if (sslFact == null) {
     ...
     */
    public top.fols.box.net.base.ftp9.FtpClient endSecureSession() throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
        if (!useCrypto) {
            return this;
        }
     ...
     * @throws IOException if an error occurred during the transmission.
     */
    public top.fols.box.net.base.ftp9.FtpClient allocate(long size) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurred during the transmission.
     */
    public top.fols.box.net.base.ftp9.FtpClient structureMount(String struct) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurred during the transmission.
     */
    public String getSystem() throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurred during transmission
     */
    public String getHelp(String cmd) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurred during transmission
     */
    public top.fols.box.net.base.ftp9.FtpClient siteCmd(String cmd) throws top.fols.box.net.base.ftp9.FtpProtocolException, IOException {

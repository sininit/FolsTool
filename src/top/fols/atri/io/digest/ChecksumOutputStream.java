...
public class ChecksumOutputStream<T extends OutputStream> extends OutputStream implements IInnerStream<T> {
	...
	public ChecksumOutputStream(Checksum d) {
		this(null, d);
	}
	
	public ChecksumOutputStream(T stream, Checksum d) {
	 ...
	 * it is on, a call to one of the <code>w</code> methods results in an

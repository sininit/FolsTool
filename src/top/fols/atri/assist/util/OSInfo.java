...
import static top.fols.atri.assist.util.OSInfo.OSType.*;

/**
 * @author Pavel Porvatov
 */
public class OSInfo {
    @SuppressWarnings({"UnnecessaryEnumModifier", "SpellCheckingInspection"})
    ...
    private final static Map<String, WindowsVersion> windowsVersionMap = new HashMap<String, WindowsVersion>();
    ...
    /******************************************************************/
    public static boolean isWindows(OSType type)    {
        return type == WINDOWS;
    }

    public static boolean isUnix(OSType type)       {
        return type == LINUX || type == SOLARIS || type == MACOSX;
    }

    public static boolean isLinux(OSType type)      { return type == LINUX; }
    public static boolean isSolaris(OSType type)    { return type == SOLARIS; }
    public static boolean isMacOsx(OSType type)     { return type == MACOSX; }
}

...
public class XStringWriter extends Writer
        implements XInterfacePrivateBuffOperat<StringBuilder>, XInterfaceReleaseBufferable {
    ...
    public XStringWriter(int initialSize) throws IllegalArgumentException {
        if (initialSize < 0) {

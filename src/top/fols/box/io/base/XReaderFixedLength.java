...
public class XReaderFixedLength<T extends Reader> extends Reader implements XInterfaceFixedLengthStream,XInterfaceGetOriginStream<T> {
	private T stream;
	private long maxCount;
	private long nowCount;
	private boolean fixed;
	public XReaderFixedLength(T stream, long maxCount) {
		if (null == stream)

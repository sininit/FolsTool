 ...
 **/
public class XByteArrayOutputStream extends OutputStream implements  XInterfacePrivateBuffOperat<byte[]>,XInterfacePrivateByteArrayBuffSearchOperat,XInterfacePrivateFixedStreamIndexOperat,XInterfereReleaseBufferable {
	// 保存“字节数组输出流”数据的数组  
	private byte buf[];  
	// “字节数组输出流”的计数  
	private int count;  

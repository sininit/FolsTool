 ...
 **/
public class InputStreamFixedLengths<T extends InputStream> extends InputStream
	...
	public InputStreamFixedLengths(T stream) {
		this(stream, 0);
		this.fixed = false;
	}

	public InputStreamFixedLengths(T stream, long maxCount) {
		if (null == stream) {

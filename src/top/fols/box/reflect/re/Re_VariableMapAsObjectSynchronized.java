...
class Re_VariableMapAsObjectSynchronized implements Re_IRe_VariableMap {
    private HashMap<Object, Re_Variable>    original     = new HashMap<>();
    ...
    public Re_IRe_VariableMap _variable_clone_all() {
        Re_VariableMapAsObjectSynchronized instance = new Re_VariableMapAsObjectSynchronized();
        instance.original = (HashMap<Object, Re_Variable>) Re_Variable.Unsafes.cloneToMap(this.original, new HashMap<Object, Re_Variable>());
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Re_VariableMapAsObjectSynchronized) {
            return originalSync.equals(((Re_VariableMapAsObjectSynchronized) obj).originalSync);
        }

...
public class ObjectArrayObject<T extends Object> extends ArrayObject<T[]> {
	public ObjectArrayObject(T[] array) { 
		super(array); 
	}
	...
	public byte byteValue(int index) {
		...
		Object value = super.array[index];
	...
	public T get(int index) { return super.array[index]; }
	...
	public void set(int index, Object value) {
		// TODO: Implement this method
		super.array[index] = (T) value;
	}
	@Override
	public void set(int index, ArrayObject value, int valueIndex) {
		// TODO: Implement this method
		super.array[index] = (T) value.objectValue(valueIndex);
	}
	...
	/**
	* @see ObjectArrayObject#equals(int, ArrayObject, int)
	*/

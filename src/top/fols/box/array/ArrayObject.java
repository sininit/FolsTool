...
public abstract class ArrayObject< T> implements IReleasable {
	protected T 	array;
	...
	public ArrayObject copy(int index, ArrayObject toArray, int toArrayIndex, int toArrayCount) {
...
//					object instanceof StringBuilder
	...
	public static <T> ArrayObject<T[]> 					wrap(T[] object) { return null == object ?null: new ObjectArrayObject<T> (object); }




	public static <T> ArrayObject<List<T>> 				wrap(List<T> object) 			{ return null == object ?null: new WrapArrayListObject<>(object); }

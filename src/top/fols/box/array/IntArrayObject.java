...
public class IntArrayObject extends ArrayObject<int[]> {
	public IntArrayObject(int[] array) { super(array); }
	...
	@Override
	public Integer objectValue(int index) {
		// TODO: Implement this method
	...
	public int get(int index) { return super.array[index]; }
	public void set(int index, int value) { super.array[index] = value; }
	...
	public void set(int index, Object value) {
		// TODO: Implement this method
		super.array[index] = (int) value;
	}
	@Override
	public void set(int index, ArrayObject value, int valueIndex) {
		// TODO: Implement this method
		super.array[index] = value.intValue(valueIndex);
	}
	...
	public boolean equals(int index, ArrayObject value, int index2) {
		// TODO: Implement this method
		return super.array[index] == value.intValue(index2);
	}

package top.fols.box.array;

import java.util.Arrays;

public class DoubleArrayObject extends ArrayObject<double[]> {
	public DoubleArrayObject(double[] array) { super(array); }
	...
	public boolean booleanValue(int index) {
		// TODO: Implement this method
		return super.array[index] != 0D;
	}
	@Override
	public Double objectValue(int index) {
		// TODO: Implement this method
	...
	@Override
	public int lengthOf(double[] array) {
		// TODO: Implement this method
		return array.length;
	}
	...
	public double get(int index) { return super.array[index]; }
	public void set(int index, long value) { super.array[index] = value; }
	...
	public boolean equals(Object obj) {
		...
		if (!ArrayObject.wrapable(obj)) { return false; }
	...
	public void set(int index, Object value) {
		// TODO: Implement this method
		super.array[index] = (double) value;
	}
	@Override
	public void set(int index, ArrayObject value, int valueIndex) {
		// TODO: Implement this method
		super.array[index] = value.doubleValue(valueIndex);
	}
	...
	public boolean equals(int index, ArrayObject value, int index2) {
		// TODO: Implement this method
		return super.array[index] == value.doubleValue(index2);
	}

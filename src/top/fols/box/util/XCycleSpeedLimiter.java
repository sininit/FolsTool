...
public class XCycleSpeedLimiter {
	...
	public static SpeedLimiterInputStream wrap(InputStream in, XCycleSpeedLimiter m) {
		return new SpeedLimiterInputStream(in, m);
	}
	public static SpeedLimiterOutputStream wrap(OutputStream in, XCycleSpeedLimiter m) {

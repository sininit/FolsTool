...
public final class XStringJoiner {
     ...
     * null, prefix + suffix is used as the empty value.
     */
     ...
     * methods accessing the value of it are invoked, it will not return a
     ...
     * string value of it are invoked, it will return the {@code prefix + suffix}
    ...
    /**
     * Returns the current value, consisting of the {@code prefix}, the values added
    ...
    /**
     * Adds a copy of the given {@code CharSequence} value as the next element of
     * the {@code StringJoiner} value. If {@code newElement} is {@code null}, then
     * {@code "null"} is added.
     *
     ...
     * or {@code emptyValue}) will be returned. The value should be equivalent to

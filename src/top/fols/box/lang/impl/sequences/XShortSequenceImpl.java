...
public class XShortSequenceImpl extends XAbstractSequence<short[], Short> implements Serializable {
	// 序列版本号
	...
	public XShortSequenceImpl(short[] array) {
		this.elementData = null == array ? XStaticFixedValue.nullshortArray : array;
	}
	...
	public boolean equals(int index, Object value) {
		...
		if (value instanceof Short)
			return elementData[index] == ((Short) value).shortValue();
		return false;
	}

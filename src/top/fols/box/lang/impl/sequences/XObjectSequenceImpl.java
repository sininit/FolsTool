...
public class XObjectSequenceImpl extends XAbstractSequence<Object[], Object> implements Serializable {
	// 序列版本号
	...
	public XObjectSequenceImpl(Object[] array) {
		this.elementData = null == array ? XStaticFixedValue.nullObjectArray : array;
	}

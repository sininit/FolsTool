...
public class XBooleanSequenceImpl extends XAbstractSequence<boolean[], Boolean> implements Serializable {
	// 序列版本号
	...
	public XBooleanSequenceImpl(boolean[] array) {
		this.elementData = null == array ? XStaticFixedValue.nullbooleanArray : array;
	}
	...
	public XBooleanSequenceImpl clone() {
		// TODO: Implement this method
		XBooleanSequenceImpl newObj = new XBooleanSequenceImpl(
				Arrays.copyOf(this.elementData, this.elementData.length));
		return newObj;
	}
	...
	public boolean equals(int index, Object value) {
		...
		if (value instanceof Boolean)
			return elementData[index] == ((Boolean) value).booleanValue();
		return false;
	}

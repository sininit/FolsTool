...
public class XIntSequenceImpl extends XAbstractSequence<int[], Integer> implements Serializable {
	// 序列版本号
	private static final long serialVersionUID = 1L;
	private int[] elementData;

	public XIntSequenceImpl(int[] array) {
		this.elementData = null == array ? XStaticFixedValue.nullintArray : array;
	}
	...
	public boolean equals(int index, Object value) {
		...
		if (value instanceof Integer)
			return elementData[index] == ((Integer) value).intValue();
		return false;
	}

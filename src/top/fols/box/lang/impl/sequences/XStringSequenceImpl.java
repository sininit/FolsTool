...
public class XStringSequenceImpl extends XAbstractSequence<String[], Object> implements Serializable {
	// 序列版本号
	...
	public XStringSequenceImpl(String[] array) {
		this.elementData = null == array ? XStaticFixedValue.nullStringArray : array;
	}
	...
	public void set(int index, Object newElement) {
		this.elementData[index] = newElement instanceof String ? (String) newElement
				: (null == newElement ? null : newElement.toString());
	}

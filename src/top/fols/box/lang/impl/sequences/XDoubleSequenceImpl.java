...
public class XDoubleSequenceImpl extends XAbstractSequence<double[], Double> implements Serializable {
	// 序列版本号
	...
	public XDoubleSequenceImpl(double[] array) {
		this.elementData = null == array ? XStaticFixedValue.nulldoubleArray : array;
	}
	...
	public boolean equals(int index, Object value) {
		...
		if (value instanceof Double)
			return elementData[index] == ((Double) value).doubleValue();
		return false;
	}

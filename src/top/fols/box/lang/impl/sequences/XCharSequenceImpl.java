...
public class XCharSequenceImpl extends XAbstractSequence<char[], Character> implements Serializable {
	// 序列版本号
	...
	public XCharSequenceImpl(char[] array) {
		this.elementData = null == array ? XStaticFixedValue.nullcharArray : array;
	}
	...
	public boolean equals(int index, Object value) {
		...
		if (value instanceof Character)
			return elementData[index] == ((Character) value).charValue();
		return false;
	}

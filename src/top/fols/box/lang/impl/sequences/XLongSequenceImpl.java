...
public class XLongSequenceImpl extends XAbstractSequence<long[], Long> implements Serializable {
	// 序列版本号
	...
	public XLongSequenceImpl(long[] array) {
		this.elementData = null == array ? XStaticFixedValue.nulllongArray : array;
	}
	...
	public boolean equals(int index, Object value) {
		...
		if (value instanceof Long)
			return elementData[index] == ((Long) value).longValue();
		return false;
	}

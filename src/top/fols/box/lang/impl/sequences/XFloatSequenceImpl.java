...
public class XFloatSequenceImpl extends XAbstractSequence<float[], Float> implements Serializable {
	// 序列版本号
	...
	public XFloatSequenceImpl(float[] array) {
		this.elementData = null == array ? XStaticFixedValue.nullfloatArray : array;
	}
	...
	public boolean equals(int index, Object value) {
		...
		if (value instanceof Float)
			return elementData[index] == ((Float) value).floatValue();
		return false;
	}

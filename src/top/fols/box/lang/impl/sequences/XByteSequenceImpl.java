...
public class XByteSequenceImpl extends XAbstractSequence<byte[], Byte> implements Serializable {
	// 序列版本号
	...
	public XByteSequenceImpl(byte[] array) {
		this.elementData = null == array ? XStaticFixedValue.nullbyteArray : array;
	}
	...
	public boolean equals(int index, Object value) {
		...
		if (value instanceof Byte)
			return elementData[index] == ((Byte) value).byteValue();
		return false;
	}

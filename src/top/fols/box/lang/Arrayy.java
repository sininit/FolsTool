...
public class Arrayy {
	...
	public static boolean equalsRange(Object originalArray, int originalArrayOff, Object objectArray, int objectArrayOff, int len) {
		if (originalArray == objectArray && originalArrayOff == objectArrayOff && originalArrayOff + len <= Array.getLength(originalArray)) return true;
		if (null == originalArray || 
			null == objectArray || 
			! Arrayx.equalsArrayType(originalArray, objectArray)) return false;
	...
	public static boolean startsWith(Object originalArray, Object objectArray, int off) { 
		if (originalArray == objectArray && off < Array.getLength(originalArray))return true;
		if (null == originalArray ||
			null == objectArray || 
			! Arrayx.equalsArrayType(originalArray, objectArray)) return false;

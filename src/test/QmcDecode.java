...
public class QmcDecode {
    ...
    public static void decodeQmcFile(String filePath) throws FileNotFoundException, IOException {
        ...
        long longPieceCount = IndexPieces.getLongPieceCount(fileLength, buflen);
        for (int i = 0; i < longPieceCount; i++) {
            int read = fis.read(buffer, 0, (int) IndexPieces.getLongPieceSize(i, longPieceCount, fileLength, buflen));

...
public abstract class CharBufferOperate extends BufferOperate<char[]> {
	...
	public int indexOfBuffer(char b, int startIndex, int indexRange) { return Arrayy.indexOf(buffer, b, startIndex, indexRange); }
	public int lastIndexOfBuffer(char b, int startIndex, int indexRange) { return Arrayy.lastIndexOf(buffer, b, startIndex, indexRange); }

	@Override public int indexOfBuffer(char[] b, int startIndex, int indexRange) { return Arrayy.indexOf(buffer, b, startIndex, indexRange); }
	@Override public int lastIndexOfBuffer(char[] b, int startIndex, int indexRange) { return Arrayy.lastIndexOf(buffer, b, startIndex, indexRange); }
	...
	static final CharBufferFilter READ_LINE_FILTER = new CharBufferFilter() {{
		char[][] LINE_SEPARATOR_ALL = Finals.LineSeparator.getAllSystemLineSeparatorCharsSortedMaxToMin();
		for (char[] bytes: LINE_SEPARATOR_ALL)
